...
public class Polzovateli {
    ...
    public String editPolzovateli(@PathVariable("id") String id, HttpSession httpSession, Model model) {
        ...
        by.kursovaa.entity.Polzovateli user = (by.kursovaa.entity.Polzovateli) httpSession.getAttribute("user");
        by.kursovaa.entity.Polzovateli polzovateli = Ejb.getInterface().lookupPolzovateliFacadeRemote().find(idUser);
    ...
    public String savePolzovateli(@ModelAttribute("polzovateli") by.kursovaa.entity.Polzovateli polzovateli,
        ...
        if (Objects.equals(user.getId(), polzovateli.getId())) {
    ...
    public String deletePolzovateli(@ModelAttribute("Polzovateli") by.kursovaa.entity.Polzovateli polzovateli,
            HttpSession httpSession, Model model) {
