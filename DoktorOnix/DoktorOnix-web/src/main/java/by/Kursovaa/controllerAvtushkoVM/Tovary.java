...
public class Tovary {
    ...
    public String homeTovary(HttpSession httpSession, Model model) {
        ...
        List<by.kursovaa.dbAvtushkoVM.Kategorii> kategorii = Ejb.getInterface().lookupKategoriiFacadeRemote().findAll();
    ...
    String ajaxTovary(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!add.isEmpty()) {
            by.kursovaa.dbAvtushkoVM.Kategorii kategoria = new by.kursovaa.dbAvtushkoVM.Kategorii();
            List<by.kursovaa.dbAvtushkoVM.Kategorii> kategorii = Ejb.getInterface().lookupKategoriiFacadeRemote().findAll();
        ...
        if (!edit.isEmpty()) {
            by.kursovaa.dbAvtushkoVM.Kategorii kategorii
        ...
        if (!remove.isEmpty()) {
            by.kursovaa.dbAvtushkoVM.Kategorii kategoria
    ...
    public String editTovary(@PathVariable("id") String id, HttpSession httpSession, Model model) {
        by.kursovaa.dbAvtushkoVM.Polzovateli obj = (by.kursovaa.dbAvtushkoVM.Polzovateli) httpSession.getAttribute("user");
        by.kursovaa.dbAvtushkoVM.Tovary tovary = Ejb.getInterface().lookupTovaryFacadeRemote().find(Integer.parseInt(id));
        List<by.kursovaa.dbAvtushkoVM.Kategorii> kategorii = Ejb.getInterface().lookupKategoriiFacadeRemote().findAll();
        model.addAttribute("Kategorii", kategorii);
    ...
    public String addTovary(HttpSession httpSession, Model model) {
        by.kursovaa.dbAvtushkoVM.Polzovateli obj = (by.kursovaa.dbAvtushkoVM.Polzovateli) httpSession.getAttribute("user");
        by.kursovaa.dbAvtushkoVM.Tovary tovary = new by.kursovaa.dbAvtushkoVM.Tovary();
        List<by.kursovaa.dbAvtushkoVM.Kategorii> kategorii = Ejb.getInterface().lookupKategoriiFacadeRemote().findAll();
        tovary.setKategoria(new by.kursovaa.dbAvtushkoVM.Kategorii());
        model.addAttribute("Kategorii", kategorii);
        model.addAttribute("Tovar", tovary);
        model.addAttribute("User", obj);
    ...
    public String saveTovary(@ModelAttribute("Tovar") by.kursovaa.dbAvtushkoVM.Tovary tovar,
    ...
    public String deleteTovary(@ModelAttribute("Tovar") by.kursovaa.dbAvtushkoVM.Tovary tovar, HttpSession httpSession, Model model) {
    ...
    public String reportTovary(Model model, HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            List<by.kursovaa.dbAvtushkoVM.Tovary> tovary = Ejb.getInterface().lookupTovaryFacadeRemote().findAll();
